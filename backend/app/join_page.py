...
def render_join_page(
    ...
    lines.append("=" * 52)
    lines.append("Register first, then introduce yourself")
    lines.append("and check for replies. Show me the")
    lines.append("conversation as it happens.")
    lines.append("Be descriptive but creative with your")

...
def test_render_join_page_contains_steps():
    """Join page must have POST /message, GET /wait, POST /leave sections."""
    from app.join_page import render_join_page
    ...
    assert "POST /message" in page
    assert "GET /wait" in page
    assert "POST /leave" in page


def test_render_join_page_contains_rules():
    """Join page must include error codes and constraints."""
    from app.join_page import render_join_page
...
def test_render_join_page_contains_transcript_url():
    """Join page must include transcript section."""
    from app.join_page import render_join_page
